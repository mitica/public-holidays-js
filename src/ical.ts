...
var parseParams = function (p: any): any {
    var out: any = {}
...
var parseValue = function (val: any) {
    if ('TRUE' === val)
        return true;
...
var storeValParam = function (name: string) {
    return function (val: any, curr: any) {
...
var storeParam = function (name: any) {
    return function (val: any, params: any, curr: any) {
        var data;
...
var addTZ = function (dt: any, params: any) {
...
var dateParam = function (name: string) {
    return function (val: any, params: any, curr: any) {

        var newDate: any = text(val);
...
var geoParam = function (name: string) {
    return function (val: any, params: any, curr: any) {
...
var categoriesParam = function (name: any) {
...
var exdateParam = function (name: any) {
    return function (val: any, params: any, curr: any) {
        var separatorPattern = /\s*,\s*/g;
        curr[name] = curr[name] || [];
        var dates = val ? val.split(separatorPattern) : [];
        dates.forEach(function (entry: any) {
...
var recurrenceParam = function (name: any) {
    return dateParam(name);
}

var addFBType = function (fb: any, params: any) {
    var p = parseParams(params);
...
var freebusyParam = function (name: any) {
    return function (val: any, params: any, curr: any) {
...
export default {
    ...
    objectHandlers: {
        'BEGIN': function (component: any, params: any, curr: any, stack: any) {
            stack.push(curr)

            return { type: component, params: params }
        }

        , 'END': function (component: any, _params: any, curr: any, stack: any) {
            ...
            if (curr.uid) {
                ...
                if (curr.recurrenceid != null) {
                    ...
                    var recurrenceObj: any = new Object();
                    var key;
                    for (key in curr) {
    ...
    handleObject: function (name: any, val: any, params: any, ctx: any, stack: any, line: any) {
